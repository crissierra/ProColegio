...
public class Teoria30_EjericiosDireccion extends AppCompatActivity  implements View.OnClickListener

{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.teoria30__ejericios_direccion);
        ...
        ANTERIOR.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent=new Intent (getApplicationContext(), Teoria28_EjerciciosDireccion.class);
                startActivity(intent);
            }
        });
