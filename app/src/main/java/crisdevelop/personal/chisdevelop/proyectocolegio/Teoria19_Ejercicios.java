...
public class Teoria19_Ejercicios extends AppCompatActivity  implements View.OnClickListener

{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.teoria19_ejercicios);
    ...
    public void playnotadevoz(View view)
    {
        switch (view.getId())
        {
            case R.id.notavoz1 :
                mediaPlayer.release();
                mediaPlayer = MediaPlayer.create(this, R.raw.toma_19_1);
                break;
            case R.id.notavoz2 :
                mediaPlayer.release();
                mediaPlayer = MediaPlayer.create(this, R.raw.toma_19_2);
                break;
