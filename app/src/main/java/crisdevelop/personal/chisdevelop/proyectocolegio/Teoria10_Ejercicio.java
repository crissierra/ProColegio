...
public class Teoria10_Ejercicio extends AppCompatActivity  implements View.OnClickListener

{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.teoria10_ejercicio);
    ...
    public void playnotadevoz(View view)
    {
        switch (view.getId())
        {
            case R.id.notavoz1 :
                mediaPlayer.release();
                mediaPlayer = MediaPlayer.create(this, R.raw.toma_10_1);
                break;
            case R.id.notavoz2 :
                mediaPlayer.release();
                mediaPlayer = MediaPlayer.create(this, R.raw.toma_10_2);
                break;
        }
        mediaPlayer.start();
    }
