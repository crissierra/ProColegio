...
public class Teoria22_Ejercicios extends AppCompatActivity  implements View.OnClickListener

{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.teoria22_ejercicios);
        ...
        CONTINUAR.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent=new Intent (getApplicationContext(), Teoria23_Splash.class);
                startActivity(intent);
            }
        });
