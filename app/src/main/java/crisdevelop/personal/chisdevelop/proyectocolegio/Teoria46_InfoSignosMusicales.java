...
public class Teoria46_InfoSignosMusicales extends AppCompatActivity  implements View.OnClickListener

{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.teoria46__info_signos_musicales);
