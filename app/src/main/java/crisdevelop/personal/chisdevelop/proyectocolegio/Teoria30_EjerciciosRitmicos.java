...
public class Teoria30_EjerciciosRitmicos extends AppCompatActivity  implements View.OnClickListener

{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.teoria30__ejercicios_ritmicos);
